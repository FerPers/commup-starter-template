...
export default async function IndustriesSection() {
  ...
  const industries = [
    { key: 'og', icon: '🛢️', label: t('og') },
    { key: 'renewables', icon: '🌬️', label: t('renewables') },
    { key: 'lng', icon: '🏭', label: t('lng') },
    { key: 'offshore', icon: '⚓', label: t('offshore') },
    { key: 'mining', icon: '⛏️', label: t('mining') },
    { key: 'industrial', icon: '🔧', label: t('industrial') },
  ]
