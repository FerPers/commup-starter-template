...
// los inspectores ejecutan preservación y NO están en EDITOR_ROLES. RLS gobierna
// esas tablas. Misma desviación documentada que itr-instances.ts (S3).

// ═══════════════════════════════════════════════════════════
// PROCEDURES
// ═══════════════════════════════════════════════════════════

export const createProcedure = withAuth(
  {
    role: EDITOR_ROLES,
    guards: [{ resource: 'discipline', field: 'disciplineId', optional: true }],
  },
  async (
    ctx,
    input: {
...
export const updateProcedure = withAuth(
  {
    role: EDITOR_ROLES,
    guards: [{ resource: 'discipline', field: 'disciplineId', optional: true }],
  },
...
export const deleteProcedure = withAuthOnly(
  { role: PRIVILEGED_ROLES },
  async (ctx, procedureId: string): Promise<{ error?: string }> => {
...
export const upsertProcedureItem = withAuth(
  { role: EDITOR_ROLES },
  async (
    ctx,
    input: {
...
export const deleteProcedureItem = withAuthOnly(
  { role: EDITOR_ROLES },
  async (ctx, itemId: string, procedureId: string): Promise<{ error?: string }> => {
    const { error } = await ctx.supabase
      .from('preservation_procedure_items')
      .delete()
      .eq('id', itemId)
...
export const reorderProcedureItems = withAuthOnly(
  { role: EDITOR_ROLES },
  async (ctx, procedureId: string, orderedIds: string[]): Promise<{ error?: string }> => {
...
export const assignPreservationPlan = withAuth(
  {
    role: EDITOR_ROLES,
    guards: [
...
export const updatePlanStatus = withAuthOnly(
  { role: EDITOR_ROLES },
  async (
    ctx,
    planId: string,
...
// ═══════════════════════════════════════════════════════════
// RECORDS (EXECUTION) — auth-only: los ejecutan inspectores (ver nota arriba)
// ═══════════════════════════════════════════════════════════

export const createPreservationRecord = withAuth(
  {
    guards: [
      { resource: 'project', field: 'projectId' },
      { resource: 'tag', field: 'tagId', scopeField: 'projectId' },
...
export const upsertRecordResponse = withAuth(
  {
    guards: [
      { resource: 'project', field: 'projectId' },
      { resource: 'tag', field: 'tagId', scopeField: 'projectId' },
...
export const finalizeRecord = withAuth(
  {
    guards: [
      { resource: 'project', field: 'projectId' },
      { resource: 'tag', field: 'tagId', scopeField: 'projectId' },
...
export const listImportableProcedures = withAuthOnly(
  { role: EDITOR_ROLES },
  async (ctx): Promise<{ procedures?: ImportableProcedure[]; error?: string }> => {
...
export const cloneProcedureToActiveOrg = withAuthOnly(
  { role: EDITOR_ROLES },
  async (
    ctx,
...
export const listPreservationAttachments = withAuth(
  {},
  async (
    ctx,
...
export const addPreservationAttachment = withAuth(
  {
    guards: [
      { resource: 'project', field: 'projectId' },
      { resource: 'tag', field: 'tagId', scopeField: 'projectId' },
...
export const deletePreservationAttachment = withAuth(
  {
    guards: [
      { resource: 'project', field: 'projectId' },
      { resource: 'tag', field: 'tagId', scopeField: 'projectId' },
